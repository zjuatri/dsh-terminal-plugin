...
export const clampDimension = M15.clampDimension
export const normalizePrefix = M15.normalizePrefix
export const resolveShell = M15.resolveShell
export const findOnPath = M15.findOnPath
export const terminalEnv = M15.terminalEnv
export const expandCwdToken = M15.expandCwdToken
export const usableDirectory = M15.usableDirectory
export const resolveWorkingDirectory = M15.resolveWorkingDirectory
export const workspacePathForSession = M15.workspacePathForSession
export const extractOscTitle = M15.extractOscTitle
export const PtySession = M15.PtySession
export const TerminalRegistry = M15.TerminalRegistry
export const TerminalLimitError = M15.TerminalLimitError
export const registerTerminalWire = M15.registerTerminalWire
export const wireDefaults = M15.wireDefaults
export const isLoopbackAuthority = M15.isLoopbackAuthority
export const PANEL_CSS = M15.PANEL_CSS
export const PLUGIN_TAG = M15.PLUGIN_TAG
export const INSET_VARIABLE = M15.INSET_VARIABLE
export const LEFT_VARIABLE = M15.LEFT_VARIABLE
export const WIDTH_VARIABLE = M15.WIDTH_VARIABLE
export const applyFrameInset = M15.applyFrameInset
export const clearFrameInset = M15.clearFrameInset
export const findFrame = M15.findFrame
export const centerBox = M15.centerBox
export const sidebarRightEdge = M15.sidebarRightEdge
export const createTerminalPanelStore = M15.createTerminalPanelStore
export const clampHeight = M15.clampHeight
export const detectLinks = M15.detectLinks
export const openableUrl = M15.openableUrl
export const fileUrlForPath = M15.fileUrlForPath
export const createLinkProvider = M15.createLinkProvider
export const attachLinkProvider = M15.attachLinkProvider
export const configModule = M15.configModule
export const shellModule = M15.shellModule
export const cwdModule = M15.cwdModule
export const protocolModule = M15.protocolModule
export const ptyModule = M15.ptyModule
export const registryModule = M15.registryModule
export const indexModule = M15.indexModule
export const wireModule = M15.wireModule
export const stylesModule = M15.stylesModule
export const frameInsetModule = M15.frameInsetModule
export const stateModule = M15.stateModule
export const linkModule = M15.linkModule
