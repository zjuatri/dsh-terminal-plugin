...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    M15.useState = useState;
    M15.useEffect = useEffect;
    M15.useLayoutEffect = useLayoutEffect;
    M15.useMemo = useMemo;
    M15.useReducer = useReducer;
    M15.useCallback = useCallback;
    M15.useRef = useRef;
    M15.useContext = useContext;
    M15.useSyncExternalStore = useSyncExternalStore;
    M15.Fragment = Fragment;
    M15.memo = memo;
    M15.forwardRef = forwardRef;
    M15.createContext = createContext;
    M15.createElement = createElement;
    M15.cloneElement = cloneElement;
    M15.Children = Children;
    M15.h = h;

    // ── 入口模块的契约导出（插件系统读取 apply / inject） ──
    exports.inject = M15.inject
    exports.apply = M15.apply
